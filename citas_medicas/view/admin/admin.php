<?php
  ...
  if(!isset($_SESSION['cargo']) || $_SESSION['cargo'] != 1){
    /*
      ...
      pero al ser datos enviados por cabecera debe ejecutarse
									...
									<li>
										<div class="user-box">
											...
											<div class="u-text">
												...
												<p class="text-muted">Administrador</p><a href="../../controller/cerrarSesion.php" class="btn btn-xs btn-secondary btn-sm">Cerrar Sesión</a>
											</div>
										</div>
									</li>
									<!-- <li>
						...
						<div class="info">
							...
							<div class="collapse in" id="collapseExample">
								<ul class="nav">
									...
									<li>
										<a href="#edit">
											<span class="link-collapse">Editar Perfil</p></span>
										</a>
									</li>
									<li>
										<a href="#settings">
