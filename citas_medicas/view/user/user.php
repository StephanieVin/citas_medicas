...
<head>
	...
	<title>Gestión de Citas Odontológicas</title>
									...
									<li>
										<div class="user-box">
											...
											<div class="u-text">
												...
												<p class="text-muted">Médicos</p><a href="../../controller/cerrarSesion.php" class="btn btn-xs btn-secondary btn-sm">Cerrar Sesión</a>
											</div>
										</div>
									</li>
									<!-- <li>
						...
						<div class="info">
							<a data-toggle="collapse" href="#collapseExample" aria-expanded="true">
								<span>
									...
									<span class="user-level">Médicos</span>
